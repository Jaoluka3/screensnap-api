...
<div class="plan featured"><div class="badge">Mais Popular</div><h3>Starter</h3><div class="price">R$79<span>/mês</span></div><ul><li>1.500 screenshots/mês</li><li>Full HD + Full Page</li><li>PDF incluso</li><li>Suporte prioritário</li><li>3 API Keys</li></ul><a href="/signup?plan=starter" class="btn btn-primary">Assinar Starter</a></div>
<div class="plan"><h3>Pro</h3><div class="price">R$199<span>/mês</span></div><ul><li>5.000 screenshots/mês</li><li>4K e Custom Size</li><li>PDF ilimitado</li><li>Suporte 24/7</li><li>API Keys ilimitadas</li></ul><a href="/signup?plan=pro" class="btn btn-primary">Assinar Pro</a></div></div></section>
...
<tr style="border-bottom:1px solid #27272a"><td style="padding:12px">Starter</td><td style="padding:12px">1.500</td><td style="padding:12px;color:#06b6d4">R$79/mês</td><td style="padding:12px;color:#06b6d4">R$790/ano</td></tr>
<tr style="border-bottom:1px solid #27272a"><td style="padding:12px">Pro</td><td style="padding:12px">5.000</td><td style="padding:12px;color:#06b6d4">R$199/mês</td><td style="padding:12px;color:#06b6d4">R$1.990/ano</td></tr></table>
